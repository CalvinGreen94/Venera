        ...
        <Center>
            <Grid pb={10} align="center" templateColumns={{sm: 'repeat(1, 1fr)', md: 'repeat(3, 1fr)'}} maxW="900">
                <GridItem colSpan={1}>
                    <Center>
                        <Text>Connect:</Text>
                        <Link href="https://twitter.com/VeneraSolutions" isExternal><Icon as={ImTwitter} color="#1DA1F2" mx={2} mt={2} /></Link>
                ...
                <GridItem colSpan={1}>
                    <Center>
                        <Text>Venera:</Text>
                        <Link href="https://etherscan.io/address/#" isExternal mx={2}>
